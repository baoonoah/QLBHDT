...
namespace LeGiaBao21._1UDPM_QLBHDT.baocaoKH {
    ...
    public partial class DataSetKH : global::System.Data.DataSet {
        ...
        public partial class KhachHangDataTable : global::System.Data.TypedTableBase<KhachHangRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public KhachHangRow AddKhachHangRow(string MaKH, string TenKH, string DiaChi, string DienThoai, string Email) {
...
namespace LeGiaBao21._1UDPM_QLBHDT.baocaoKH.DataSetKHTableAdapters {
    ...
    public partial class KhachHangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[KhachHang] WHERE (([MaKH] = @Original_MaKH) AND ([TenKH] = @Or" +
                ...
                "nThoai) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Ema" +
                "il)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[KhachHang] ([MaKH], [TenKH], [DiaChi], [DienThoai], [Email]) V" +
                "ALUES (@MaKH, @TenKH, @DiaChi, @DienThoai, @Email);\r\nSELECT MaKH, TenKH, DiaChi," +
                " DienThoai, Email FROM KhachHang WHERE (MaKH = @MaKH)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[KhachHang] SET [MaKH] = @MaKH, [TenKH] = @TenKH, [DiaChi] = @DiaChi, [DienThoai] = @DienThoai, [Email] = @Email WHERE (([MaKH] = @Original_MaKH) AND ([TenKH] = @Original_TenKH) AND ([DiaChi] = @Original_DiaChi) AND ([DienThoai] = @Original_DienThoai) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT MaKH, TenKH, DiaChi, DienThoai, Email FROM KhachHang WHERE (MaKH = @MaKH)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaKH, TenKH, DiaChi, DienThoai, Email FROM dbo.KhachHang";
        ...
        public virtual int Fill(DataSetKH.KhachHangDataTable dataTable) {
        ...
        public virtual DataSetKH.KhachHangDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetKH.KhachHangDataTable dataTable = new DataSetKH.KhachHangDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetKH.KhachHangDataTable dataTable) {
        ...
        public virtual int Delete(string Original_MaKH, string Original_TenKH, string Original_DiaChi, string Original_DienThoai, string Original_Email) {
        ...
        public virtual int Insert(string MaKH, string TenKH, string DiaChi, string DienThoai, string Email) {
            if ((MaKH == null)) {
        ...
        public virtual int Update(string MaKH, string TenKH, string DiaChi, string DienThoai, string Email, string Original_MaKH, string Original_TenKH, string Original_DiaChi, string Original_DienThoai, string Original_Email) {
            if ((MaKH == null)) {
                throw new global::System.ArgumentNullException("MaKH");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenKH, string DiaChi, string DienThoai, string Email, string Original_MaKH, string Original_TenKH, string Original_DiaChi, string Original_DienThoai, string Original_Email) {
            return this.Update(Original_MaKH, TenKH, DiaChi, DienThoai, Email, Original_MaKH, Original_TenKH, Original_DiaChi, Original_DienThoai, Original_Email);
        }
    }
